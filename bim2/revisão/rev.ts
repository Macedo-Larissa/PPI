class Elevador {
    private capacidade: number; // Capacidade máxima de pessoas no elevador
    private totalAndares: number; // Número total de andares no prédio
    private andarAtual: number; // Andar atual em que o elevador se encontra
    private quantidadePessoas: number; // Quantidade de pessoas presentes no elevador
    private portaAberta: boolean; // Estado da porta do elevador (aberta ou fechada)
...
class Hospede {
    private nome: string; // Nome do hóspede
    private cpf: string; // CPF do hóspede
...
class Aposento {
    private numero: number; // Número do aposento
    private precoDiaria: number; // Preço da diária do aposento
...
class Hospedagem {
    private hospedes: Hospede[]; // Lista de hóspedes
    private aposento: Aposento; // Aposento reservado
...
class ItemPedido {
    ...
    private quantidade: number; // Quantidade comprada do produto
...
class Pedido {
    private itens: ItemPedido[]; // Lista de itens do pedido
    ...
    public adicionar_item(item: ItemPedido): void {
        // Método para adicionar um item à lista de itens do pedido
        this.itens.push(item);
    }

    public obter_total(): number {
